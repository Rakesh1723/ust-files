...
public class TraineeControllerUnitTest {
    ...
    void getTrainee() throws Exception {
        ...
        // Given
        Trainee trainee = new Trainee(1,"Harsh","Kerala", LocalDate.now(),null);
        int id = 1;
        int invalidId=100;
        ...
        mockMvc.perform(get("/api/v1/trainees/"+id))
                ...
                .andExpect(jsonPath("$.joinedDate", Matchers.is(trainee.getJoinedDate().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")))))
                .andExpect(jsonPath("$.project",Matchers.is(trainee.getProject())))
                .andReturn();
    ...
    void saveTrainee() throws Exception {
        ...
        // Given
        Trainee trainee = new Trainee(1,"Harsh","Kerala", LocalDate.parse("2024-10-14"),null);
        int id = 1;
